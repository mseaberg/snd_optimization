...
import pickle
import os
from snd_optimization.lcls_beamline_toolbox.utility.util import Util, LegendreUtil
from snd_optimization.lcls_beamline_toolbox.utility.pitch import TalbotLineout, TalbotImage
from snd_optimization.lcls_beamline_toolbox.xraybeamline2d.optics import PPM as PPM_2D
import scipy.interpolate as interpolate
import xrt.backends.raycing.materials as materials
import xrt.backends.raycing.materials_crystals as xcryst
import xraydb
from snd_optimization.lcls_beamline_toolbox.xrayinteraction import interaction
...
class PPM:
    ...
    def calc_profile(self, beam, shift=True):
        ...
        if self.blur:
            ...
            y_width = self.resolution / beam.dy
            # apply blurring using ndimage gaussian_filter
            self.x_phase = ndimage.filters.gaussian_filter1d(self.x_phase, x_width)
            self.y_phase = ndimage.filters.gaussian_filter1d(self.y_phase, y_width)
