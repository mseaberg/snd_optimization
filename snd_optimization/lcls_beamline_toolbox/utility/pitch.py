...
try:
    ...
    use_gpu=False
from snd_optimization.lcls_beamline_toolbox.polyprojection.legendre import LegendreFit1D
from snd_optimization.lcls_beamline_toolbox.xraybeamline2d.beam import Beam
from snd_optimization.lcls_beamline_toolbox.utility.util import Util
import time
