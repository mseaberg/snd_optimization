...
MOTION_RANGE = 2e-6     # angular search range per knob (rad)
N_INIT = 0              # random initial samples
NUM_ITER = 200           # optimizer steps after init
...
MOVE_TO_OPTIMUM = False   # move to the best sample when finished
