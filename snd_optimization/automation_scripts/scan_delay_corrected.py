...
IP_x = AvgSignal(EpicsSignalRO('XCS:USER:SND:X_CENTROID_SHMEM',name='IP_x'),60*4,duration,name='IP_x')
IP_y = AvgSignal(EpicsSignalRO('XCS:USER:SND:Y_CENTROID_SHMEM',name='IP_y'),60*4,duration,name='IP_y')
IP_intensity = AvgSignal(EpicsSignalRO('XCS:USER:SND:INTENSITY_SHMEM',name='IP_intensity'),60*4,duration,name='IP_intensity')
...
time.sleep(0.1)
positions = np.linspace(-5,25,301)
A = 14.376
T = 2.364
phi = -.543
p1 = 0.371
